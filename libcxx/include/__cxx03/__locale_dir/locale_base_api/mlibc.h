...
// missing from the Mlibc C library.
//
// copy of musl.h in this folder
//===----------------------------------------------------------------------===//

#ifndef _LIBCPP___CXX03___LOCALE_LOCALE_BASE_API_MLIBC_H
#define _LIBCPP___CXX03___LOCALE_LOCALE_BASE_API_MLIBC_H
...
#endif // _LIBCPP___CXX03___LOCALE_LOCALE_BASE_API_MLIBC_H
