...
#ifndef SCUDO_MEM_MAP_WOS_H_
#define SCUDO_MEM_MAP_WOS_H_
...
class MemMapWOS final : public MemMapBase<MemMapWOS> {
public:
  constexpr MemMapWOS() = default;
  MemMapWOS(uptr Base, uptr Capacity) : MapBase(Base), MapCapacity(Capacity) {}
...
class ReservedMemoryWOS final
    : public ReservedMemory<ReservedMemoryWOS, MemMapWOS> {
public:
